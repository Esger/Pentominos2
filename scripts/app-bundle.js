...
define('components/board',['exports', 'aurelia-framework', 'aurelia-event-aggregator', '../services/pentomino-service'], function (exports, _aureliaFramework, _aureliaEventAggregator, _pentominoService) {
    'use strict';
    ...
    var BoardCustomElement = exports.BoardCustomElement = (_dec = (0, _aureliaFramework.inject)(_aureliaEventAggregator.EventAggregator, _pentominoService.PentominoService), _dec(_class = function () {
        function BoardCustomElement(eventAggregator, pentominoService) {
        ...
        BoardCustomElement.prototype.getBoardSizeCSS = function getBoardSizeCSS() {
            var boardType = this.ps.boardTypes[this.ps.boardType];
            var css = {
...
define('components/pentominos',['exports', 'aurelia-framework', 'aurelia-event-aggregator', '../services/pentomino-service'], function (exports, _aureliaFramework, _aureliaEventAggregator, _pentominoService) {
    'use strict';
    ...
    var PentominosCustomElement = exports.PentominosCustomElement = (_dec = (0, _aureliaFramework.inject)(_aureliaEventAggregator.EventAggregator, _pentominoService.PentominoService), _dec(_class = function () {
        function PentominosCustomElement(eventAggregator, pentominoService) {
...
define('services/pentomino-service',['exports', 'aurelia-framework', 'aurelia-event-aggregator', './data-service'], function (exports, _aureliaFramework, _aureliaEventAggregator, _dataService) {
    'use strict';
    ...
    var PentominoService = exports.PentominoService = (_dec = (0, _aureliaFramework.inject)(_aureliaEventAggregator.EventAggregator, _dataService.DataService), _dec(_class = function () {
        function PentominoService(eventAggregator, dataService) {
            var _this = this;
...
define('components/header',['exports', 'aurelia-framework', '../services/pentomino-service'], function (exports, _aureliaFramework, _pentominoService) {
    'use strict';
    ...
    var HeaderCustomElement = exports.HeaderCustomElement = (_dec = (0, _aureliaFramework.inject)(_pentominoService.PentominoService), _dec(_class = function () {
        function HeaderCustomElement(pentominoService) {
